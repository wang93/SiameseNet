...
python main_reid.py train  --dataset=market1501 --test_batch=256 --workers=32  \
       --model_name=$model_name --exp_name=$exp_name --train_phase_num=2 --eval_phase_num=2 --gpus=$gpus --feats=$feats --sort_pairs_by_scores=train

python main_reid.py train  --dataset=market1501 --test_batch=256 --workers=32  \
       --model_name=$model_name --exp_name=$exp_name --train_phase_num=2 --eval_phase_num=2 --gpus=$gpus --feats=$feats --sort_pairs_by_scores=test