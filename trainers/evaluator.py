...
from utils.adaptive_batchsize import get_max_equal_batchsize
...
class ReIDEvaluator:
    ...
    def _compare_features(self, a, b):
        ...
        with torch.no_grad():
            ...
            batch_size = get_max_equal_batchsize(fun, slice_tensor(a, [0]), slice_tensor(b, [0]))
    ...
    def _get_feature(self, dataloader):
        with torch.no_grad():
            ...
            batch_size = get_max_equal_batchsize(fun, slice_tensor(next(iter(dataloader))[0], [0]))
